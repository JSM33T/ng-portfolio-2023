...
<div class="bg-primary bg-opacity-10 rounded-circle position-absolute start-50 d-none d-lg-block"
  style="bottom: 220px; width: 480px; height: 480px; margin-left: -240px;" data-aos="zoom-in" data-aos-duration="700"
  data-aos-delay="200" data-aos-offset="300"></div>
<div class="container position-relative z-5 mt-2 pt-5 pb-2 pb-sm-4 pb-lg-5">
  <div class="display-3 text-center text-primary mx-auto pt-5 my-2 my-sm-4" style="max-width: 680px;">
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="300.000000pt" height="70.000000pt" 
      viewBox="0 0 1000.000000 300.000000" preserveAspectRatio="xMidYMid meet" style="margin-left: 0px;">
...
<div class="pt-4 pt-sm-3 mt-md-3">
  <h1 class="pb-3 mb-2 mb-sm-3 mb-lg-4" data-aos="flip-up" data-aos-duration="300">Hi this is <span
      class='text-primary'>Jass</span>
  </h1>
  <p class="fs-lg" data-aos="fade-in" data-aos-duration="500">
    &nbsp;&nbsp;&nbsp;&nbsp;I am a full-stack web developer with a strong focus on writing efficient business logic,
    specializing in <span _ngcontent-ng-cli-universal-c5="" class="text-primary">.NET, C#</span> (MVC,Web Api's,Razor
    Pages). I have
    successfully crafted and implemented intricate web applications that drive efficiency and results for businesses.
    Proficient in UI design using Bootstrap and have a command over <span _ngcontent-ng-cli-universal-c5=""
      class="text-primary">Vue Js</span>, allowing me to create visually appealing and highly responsive user
    interfaces. I'm also in the early stages of my journey with <span _ngcontent-ng-cli-universal-c5=""
      class="text-primary">Angular</span>, eagerly learning and expanding my skill set to become well-versed in this
    popular front-end framework.
  </p>
  <div class="d-flex">
    <div class="d-flex">
      <a *ngFor="let link of socialLinks"
        class="btn btn-outline-secondary btn-icon btn-sm {{ 'btn-' + link.platform.toLowerCase() }} me-3"
...
<div class="row py-5 my-md-2 my-lg-3 my-xl-4 my-xxl-5">
  <div class="col-sm-7 mb-4 mb-sm-0">
    <div class="position-relative mb-4">
      <div class="position-absolute top-0 start-0 w-100 h-100" style="background-color: #796194;" data-aos="zoom-in"
        data-aos-duration="700" data-aos-offset="250"></div><img class="position-relative zindex-2"
        src="assets/images/about/img1.png" alt="Image" width="400" height="600" data-aos="flip-right"
        data-aos-duration="400" data-aos-offset="250">
    </div>
    <div class="position-relative">
      <div class="bg-black position-absolute top-0 start-0 w-100 h-100" data-aos="zoom-in" data-aos-duration="700"
        data-aos-offset="250"></div><img class="position-relative zindex-2" src="assets/images/about/img2.png"
        width="400" height="600" alt="Image" data-aos="zoom-in" data-aos-duration="400" data-aos-offset="550">
    </div>
  </div>
  <div class="col-sm-5">
    <div class="position-relative">
      <div class="position-absolute top-0 start-0 w-100 h-100" style="max-height: 588px; background-color: #216d2a;"
        data-aos="zoom-in" data-aos-duration="700" data-aos-offset="250"></div><img class="position-relative zindex-2"
        width="400" height="600" src="assets/images/about/img3.png" alt="Image" data-aos="zoom-in"
